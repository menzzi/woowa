...
- [ ] 주문 -> "[ERROR] 유효하지 않은 주문입니다. 다시 입력해 주세요."
  - [ ] 메뉴 형식이 예시와 다른 경우 - InputView
  - [ ] 중복 메뉴를 입력한 경우 - InputView..?
  - [x] 고객이 메뉴판에 없는 메뉴를 입력 -> domain - MenuCategory에서 구현
  - [ ] 음료만 주문시 주문할 수 없다고 에러
  - 개수
  - [ ] 메뉴의 개수는 1 이상 -> InputView
  - [ ] 총 개수 20 넘으면 에러..?는 아니고 다시 주문해달라고 하기? -> InputView..?
  - [ ] 숫자만 입력  -> 
